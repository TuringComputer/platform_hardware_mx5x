...
namespace android{
    ...
    CAPTURE_DEVICE_ERR_RET V4l2CapDeviceBase :: DevGetStd(TVinType *pTvStd){

        CAMERA_HAL_LOG_FUNC;
        if (mCameraDevice <= 0 || pTvStd == NULL){
            return CAPTURE_DEVICE_ERR_BAD_PARAM;
        }

        mTvType = *pTvStd;
        return V4l2GetStd(pTvStd);

    }

    CAPTURE_DEVICE_ERR_RET V4l2CapDeviceBase :: DevSetInputSource(int src){
	...
	CAMERA_HAL_LOG_RUNTIME("V4l2CapDeviceBase::V4l2SetConfig: Set the Format :%c%c%c%c\n",
    ...
    CAPTURE_DEVICE_ERR_RET V4l2CapDeviceBase :: V4l2GetStd(TVinType *pTvType){
        CAMERA_HAL_LOG_FUNC;
        CAPTURE_DEVICE_ERR_RET ret = CAPTURE_DEVICE_ERR_NONE;
    ...
    CAPTURE_DEVICE_ERR_RET V4l2CapDeviceBase :: V4l2SetInputSrc(int src){
		CAMERA_HAL_LOG_FUNC;
		CAPTURE_DEVICE_ERR_RET ret = CAPTURE_DEVICE_ERR_NONE;
		if (mCameraDevice <= 0){
			return CAPTURE_DEVICE_ERR_BAD_PARAM;
		...
		//For uvc or ov Camera do nothing here.
