...
namespace android{
    ...
    public:
        ...
        virtual CAPTURE_DEVICE_ERR_RET DevGetStd(TVinType *pTvStd);
        virtual CAPTURE_DEVICE_ERR_RET DevSetInputSource(int src);
    ...
    protected:
        ...
        virtual CAPTURE_DEVICE_ERR_RET V4l2GetStd(TVinType *pTvStd);
        virtual CAPTURE_DEVICE_ERR_RET V4l2SetInputSrc(int src);
