...
class V4l2CsiDevice : public V4l2CapDeviceBase{
    ...
    protected:
		...
		CAPTURE_DEVICE_ERR_RET V4l2GetStd(TVinType *pTvType);
		CAPTURE_DEVICE_ERR_RET V4l2SetInputSrc(int src);
